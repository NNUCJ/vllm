...
class GPUModelRunner(LoRAModelRunnerMixin):
    ...
    def execute_model(
    ...
    ) -> Union[ModelRunnerOutput, AsyncModelRunnerOutput, torch.Tensor]:
        ...
        if not self.use_async_scheduling:       # 同步调度模式
